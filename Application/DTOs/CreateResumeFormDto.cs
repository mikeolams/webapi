...
{
    public class CreateResumeFormDto(int ResumeId, string FullName, string Gender, DateOnly DateOfBirth, string Nationality, string EduHistory, string WorkExperience, IFormFile PassportPhotograph)
    {
